...
@InputType()
class DiscountCreateNestedManyWithoutDiscountTypesInput {
...
export { DiscountCreateNestedManyWithoutDiscountTypesInput as DiscountCreateNestedManyWithoutDiscountTypesInput };
