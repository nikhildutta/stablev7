...
@InputType()
class OptionsAddonsGroupCreateInput {
  @ApiProperty({
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () =>
      OptionsAddOnsItemCreateNestedManyWithoutOptionsAddonsGroupsInput,
  })
  @ValidateNested()
  @Type(() => OptionsAddOnsItemCreateNestedManyWithoutOptionsAddonsGroupsInput)
  @IsOptional()
  @Field(
    () => OptionsAddOnsItemCreateNestedManyWithoutOptionsAddonsGroupsInput,
    {
...
export { OptionsAddonsGroupCreateInput as OptionsAddonsGroupCreateInput };
