...
@InputType()
class ComplaintsPhotoCreateNestedManyWithoutComplaintsBooksInput {
...
export { ComplaintsPhotoCreateNestedManyWithoutComplaintsBooksInput as ComplaintsPhotoCreateNestedManyWithoutComplaintsBooksInput };
