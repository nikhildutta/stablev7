...
@InputType()
class SettlementsBreakupCreateNestedManyWithoutPayoutCyclesInput {
...
export { SettlementsBreakupCreateNestedManyWithoutPayoutCyclesInput as SettlementsBreakupCreateNestedManyWithoutPayoutCyclesInput };
