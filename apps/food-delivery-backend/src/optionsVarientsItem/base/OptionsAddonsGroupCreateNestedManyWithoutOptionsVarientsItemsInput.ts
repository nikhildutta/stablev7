...
@InputType()
class OptionsAddonsGroupCreateNestedManyWithoutOptionsVarientsItemsInput {
...
export { OptionsAddonsGroupCreateNestedManyWithoutOptionsVarientsItemsInput as OptionsAddonsGroupCreateNestedManyWithoutOptionsVarientsItemsInput };
