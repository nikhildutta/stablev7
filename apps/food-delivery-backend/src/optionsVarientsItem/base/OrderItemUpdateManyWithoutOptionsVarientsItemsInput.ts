...
@InputType()
class OrderItemUpdateManyWithoutOptionsVarientsItemsInput {
...
export { OrderItemUpdateManyWithoutOptionsVarientsItemsInput as OrderItemUpdateManyWithoutOptionsVarientsItemsInput };
