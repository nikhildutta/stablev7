...
const CREATE_INPUT = {
  additionaldetails: "exampleAdditionaldetails",
...
describe("Customer", () => {
  ...
  test("POST /customers", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...CREATE_RESULT,
        anniversary: CREATE_RESULT.anniversary.toISOString(),
  ...
  test("GET /customers", async () => {
    await request(app.getHttpServer())
      ...
      .expect([
        {
          ...FIND_MANY_RESULT[0],
          anniversary: FIND_MANY_RESULT[0].anniversary.toISOString(),
  ...
  test("GET /customers/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...FIND_ONE_RESULT,
        anniversary: FIND_ONE_RESULT.anniversary.toISOString(),
