...
@InputType()
class CustomerSubscriptionUpdateManyWithoutSubscriptionsInput {
...
export { CustomerSubscriptionUpdateManyWithoutSubscriptionsInput as CustomerSubscriptionUpdateManyWithoutSubscriptionsInput };
