...
@InputType()
class CustomerSubscriptionCreateNestedManyWithoutSubscriptionsInput {
...
export { CustomerSubscriptionCreateNestedManyWithoutSubscriptionsInput as CustomerSubscriptionCreateNestedManyWithoutSubscriptionsInput };
