...
@InputType()
class DiscountMenuItemUpdateManyWithoutDiscountsInput {
...
export { DiscountMenuItemUpdateManyWithoutDiscountsInput as DiscountMenuItemUpdateManyWithoutDiscountsInput };
