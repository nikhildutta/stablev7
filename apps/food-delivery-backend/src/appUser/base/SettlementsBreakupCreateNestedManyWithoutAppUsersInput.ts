...
@InputType()
class SettlementsBreakupCreateNestedManyWithoutAppUsersInput {
...
export { SettlementsBreakupCreateNestedManyWithoutAppUsersInput as SettlementsBreakupCreateNestedManyWithoutAppUsersInput };
