...
@InputType()
class OrderHistoryCreateNestedManyWithoutAppUsersInput {
...
export { OrderHistoryCreateNestedManyWithoutAppUsersInput as OrderHistoryCreateNestedManyWithoutAppUsersInput };
