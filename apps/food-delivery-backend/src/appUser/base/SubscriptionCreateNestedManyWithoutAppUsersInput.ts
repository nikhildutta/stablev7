...
@InputType()
class SubscriptionCreateNestedManyWithoutAppUsersInput {
...
export { SubscriptionCreateNestedManyWithoutAppUsersInput as SubscriptionCreateNestedManyWithoutAppUsersInput };
