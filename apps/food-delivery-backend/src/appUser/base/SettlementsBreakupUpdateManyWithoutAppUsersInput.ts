...
@InputType()
class SettlementsBreakupUpdateManyWithoutAppUsersInput {
...
export { SettlementsBreakupUpdateManyWithoutAppUsersInput as SettlementsBreakupUpdateManyWithoutAppUsersInput };
