...
@InputType()
class NotificationSettingCreateNestedManyWithoutAppUsersInput {
...
export { NotificationSettingCreateNestedManyWithoutAppUsersInput as NotificationSettingCreateNestedManyWithoutAppUsersInput };
