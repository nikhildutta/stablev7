...
@InputType()
class CustomerSubscriptionCreateNestedManyWithoutAppUsersInput {
...
export { CustomerSubscriptionCreateNestedManyWithoutAppUsersInput as CustomerSubscriptionCreateNestedManyWithoutAppUsersInput };
