...
@InputType()
class CustomerSubscriptionUpdateManyWithoutAppUsersInput {
...
export { CustomerSubscriptionUpdateManyWithoutAppUsersInput as CustomerSubscriptionUpdateManyWithoutAppUsersInput };
