...
@InputType()
class ReservationCreateNestedManyWithoutAppUsersInput {
...
export { ReservationCreateNestedManyWithoutAppUsersInput as ReservationCreateNestedManyWithoutAppUsersInput };
