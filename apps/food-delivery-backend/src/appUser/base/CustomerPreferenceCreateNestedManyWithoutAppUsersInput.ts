...
@InputType()
class CustomerPreferenceCreateNestedManyWithoutAppUsersInput {
...
export { CustomerPreferenceCreateNestedManyWithoutAppUsersInput as CustomerPreferenceCreateNestedManyWithoutAppUsersInput };
