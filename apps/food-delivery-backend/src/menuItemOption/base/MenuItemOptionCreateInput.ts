...
@InputType()
class MenuItemOptionCreateInput {
  @ApiProperty({
    required: false,
    type: Number,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => OptionsVarientsGroupCreateNestedManyWithoutMenuItemOptionsInput,
  })
  @ValidateNested()
  @Type(() => OptionsVarientsGroupCreateNestedManyWithoutMenuItemOptionsInput)
  @IsOptional()
  @Field(
    () => OptionsVarientsGroupCreateNestedManyWithoutMenuItemOptionsInput,
    {
      nullable: true,
    }
  )
...
export { MenuItemOptionCreateInput as MenuItemOptionCreateInput };
