...
@InputType()
class OptionsVarientsGroupCreateNestedManyWithoutMenuItemOptionsInput {
...
export { OptionsVarientsGroupCreateNestedManyWithoutMenuItemOptionsInput as OptionsVarientsGroupCreateNestedManyWithoutMenuItemOptionsInput };
