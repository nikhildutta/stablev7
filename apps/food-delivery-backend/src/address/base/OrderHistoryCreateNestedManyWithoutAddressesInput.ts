...
@InputType()
class OrderHistoryCreateNestedManyWithoutAddressesInput {
...
export { OrderHistoryCreateNestedManyWithoutAddressesInput as OrderHistoryCreateNestedManyWithoutAddressesInput };
