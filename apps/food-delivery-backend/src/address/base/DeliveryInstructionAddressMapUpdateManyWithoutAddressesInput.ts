...
@InputType()
class DeliveryInstructionAddressMapUpdateManyWithoutAddressesInput {
...
export { DeliveryInstructionAddressMapUpdateManyWithoutAddressesInput as DeliveryInstructionAddressMapUpdateManyWithoutAddressesInput };
