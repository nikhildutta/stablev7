...
@InputType()
class ContactDetailCreateNestedManyWithoutAddressesInput {
...
export { ContactDetailCreateNestedManyWithoutAddressesInput as ContactDetailCreateNestedManyWithoutAddressesInput };
