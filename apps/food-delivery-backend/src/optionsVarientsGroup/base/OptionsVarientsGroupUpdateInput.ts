...
@InputType()
class OptionsVarientsGroupUpdateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => OptionsVarientsItemUpdateManyWithoutOptionsVarientsGroupsInput,
  })
  @ValidateNested()
  @Type(() => OptionsVarientsItemUpdateManyWithoutOptionsVarientsGroupsInput)
  @IsOptional()
  @Field(() => OptionsVarientsItemUpdateManyWithoutOptionsVarientsGroupsInput, {
    nullable: true,
  })
...
export { OptionsVarientsGroupUpdateInput as OptionsVarientsGroupUpdateInput };
