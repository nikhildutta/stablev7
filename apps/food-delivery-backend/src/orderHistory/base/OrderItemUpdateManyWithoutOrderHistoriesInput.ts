...
@InputType()
class OrderItemUpdateManyWithoutOrderHistoriesInput {
...
export { OrderItemUpdateManyWithoutOrderHistoriesInput as OrderItemUpdateManyWithoutOrderHistoriesInput };
