...
@InputType()
class SettlementsBreakupUpdateManyWithoutOrderHistoriesInput {
...
export { SettlementsBreakupUpdateManyWithoutOrderHistoriesInput as SettlementsBreakupUpdateManyWithoutOrderHistoriesInput };
