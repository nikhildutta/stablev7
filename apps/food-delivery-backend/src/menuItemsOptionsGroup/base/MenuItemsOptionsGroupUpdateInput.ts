...
@InputType()
class MenuItemsOptionsGroupUpdateInput {
  @ApiProperty({
    required: false,
    type: Number,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => MenuItemOptionUpdateManyWithoutMenuItemsOptionsGroupsInput,
  })
  @ValidateNested()
  @Type(() => MenuItemOptionUpdateManyWithoutMenuItemsOptionsGroupsInput)
  @IsOptional()
  @Field(() => MenuItemOptionUpdateManyWithoutMenuItemsOptionsGroupsInput, {
    nullable: true,
  })
...
export { MenuItemsOptionsGroupUpdateInput as MenuItemsOptionsGroupUpdateInput };
