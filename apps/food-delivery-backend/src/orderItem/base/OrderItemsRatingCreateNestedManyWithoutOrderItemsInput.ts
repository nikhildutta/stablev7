...
@InputType()
class OrderItemsRatingCreateNestedManyWithoutOrderItemsInput {
...
export { OrderItemsRatingCreateNestedManyWithoutOrderItemsInput as OrderItemsRatingCreateNestedManyWithoutOrderItemsInput };
