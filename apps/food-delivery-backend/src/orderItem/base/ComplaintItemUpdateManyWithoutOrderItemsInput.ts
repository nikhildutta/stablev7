...
@InputType()
class ComplaintItemUpdateManyWithoutOrderItemsInput {
...
export { ComplaintItemUpdateManyWithoutOrderItemsInput as ComplaintItemUpdateManyWithoutOrderItemsInput };
