...
const CREATE_INPUT = {
  ...
  email: "exampleEmail",
  fssaiLicenseNumber: "exampleFssaiLicenseNumber",
  fssaiLicenseUrl: "exampleFssaiLicenseUrl",
  fssaiValidFrom: new Date(),
  fssaiValidTo: new Date(),
  id: "exampleId",
  ...
  test("POST /accounts", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        fssaiValidFrom: CREATE_RESULT.fssaiValidFrom.toISOString(),
        fssaiValidTo: CREATE_RESULT.fssaiValidTo.toISOString(),
      ...
      .expect([
        {
          ...
          fssaiValidFrom: FIND_MANY_RESULT[0].fssaiValidFrom.toISOString(),
          fssaiValidTo: FIND_MANY_RESULT[0].fssaiValidTo.toISOString(),
  ...
  test("GET /accounts/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        fssaiValidFrom: FIND_ONE_RESULT.fssaiValidFrom.toISOString(),
        fssaiValidTo: FIND_ONE_RESULT.fssaiValidTo.toISOString(),
