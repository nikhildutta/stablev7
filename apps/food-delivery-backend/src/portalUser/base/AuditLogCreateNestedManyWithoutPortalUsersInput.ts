...
@InputType()
class AuditLogCreateNestedManyWithoutPortalUsersInput {
...
export { AuditLogCreateNestedManyWithoutPortalUsersInput as AuditLogCreateNestedManyWithoutPortalUsersInput };
