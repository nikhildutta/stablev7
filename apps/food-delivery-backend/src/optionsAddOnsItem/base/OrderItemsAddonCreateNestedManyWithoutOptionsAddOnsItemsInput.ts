...
@InputType()
class OrderItemsAddonCreateNestedManyWithoutOptionsAddOnsItemsInput {
...
export { OrderItemsAddonCreateNestedManyWithoutOptionsAddOnsItemsInput as OrderItemsAddonCreateNestedManyWithoutOptionsAddOnsItemsInput };
