...
@InputType()
class OrderHistoryCreateNestedManyWithoutCouponsInput {
...
export { OrderHistoryCreateNestedManyWithoutCouponsInput as OrderHistoryCreateNestedManyWithoutCouponsInput };
