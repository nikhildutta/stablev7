...
@InputType()
class ReservationCreateNestedManyWithoutRestaurantsInput {
...
export { ReservationCreateNestedManyWithoutRestaurantsInput as ReservationCreateNestedManyWithoutRestaurantsInput };
