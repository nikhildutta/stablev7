...
@InputType()
class AccountRestaurantLookupUpdateManyWithoutRestaurantsInput {
...
export { AccountRestaurantLookupUpdateManyWithoutRestaurantsInput as AccountRestaurantLookupUpdateManyWithoutRestaurantsInput };
