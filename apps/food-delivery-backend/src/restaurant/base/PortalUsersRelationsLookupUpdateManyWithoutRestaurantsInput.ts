...
@InputType()
class PortalUsersRelationsLookupUpdateManyWithoutRestaurantsInput {
...
export { PortalUsersRelationsLookupUpdateManyWithoutRestaurantsInput as PortalUsersRelationsLookupUpdateManyWithoutRestaurantsInput };
