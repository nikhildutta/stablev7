...
@InputType()
class AccountRestaurantLookupCreateNestedManyWithoutRestaurantsInput {
...
export { AccountRestaurantLookupCreateNestedManyWithoutRestaurantsInput as AccountRestaurantLookupCreateNestedManyWithoutRestaurantsInput };
